...
public class CTRelationshipsGroupReferenceImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements org.openxmlformats.schemas.xpackage.x2006.digitalSignature.CTRelationshipsGroupReference
{
    ...
    private static final javax.xml.namespace.QName SOURCETYPE$0 = 
    ...
    public java.lang.String getSourceType()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(SOURCETYPE$0);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlAnyURI xgetSourceType()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlAnyURI)get_store().find_attribute_user(SOURCETYPE$0);
            return target;
        }
    }
    ...
    public void setSourceType(java.lang.String sourceType)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(SOURCETYPE$0);
            }
    ...
    public void xsetSourceType(org.apache.xmlbeans.XmlAnyURI sourceType)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlAnyURI)get_store().add_attribute_user(SOURCETYPE$0);
            }
