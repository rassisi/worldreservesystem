...
public final class PICT extends Metafile {
	public static class NativeHeader {
		...
		private static final byte V2_HEADER[] = { 0x00, 0x11, // v2 version
																// opcode
		...
		public NativeHeader(byte data[], int offset) {
			...
			offset += 2;
			int x1 = readUnsignedShort(data, offset);
			offset += 2;
			int y2 = readUnsignedShort(data, offset);
			offset += 2;
			int x2 = readUnsignedShort(data, offset);
			offset += 2;
