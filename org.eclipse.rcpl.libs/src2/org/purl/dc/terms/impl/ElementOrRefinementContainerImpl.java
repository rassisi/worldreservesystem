 ...
 */
public class ElementOrRefinementContainerImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.purl.dc.terms.ElementOrRefinementContainer
{
    
    public ElementOrRefinementContainerImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public java.util.List<org.purl.dc.elements.x11.SimpleLiteral> getAnyList()
    {
        final class AnyList extends java.util.AbstractList<org.purl.dc.elements.x11.SimpleLiteral>
        {
            public org.purl.dc.elements.x11.SimpleLiteral get(int i)
                { return ElementOrRefinementContainerImpl.this.getAnyArray(i); }
            
            public org.purl.dc.elements.x11.SimpleLiteral set(int i, org.purl.dc.elements.x11.SimpleLiteral o)
            {
                org.purl.dc.elements.x11.SimpleLiteral old = ElementOrRefinementContainerImpl.this.getAnyArray(i);
                ElementOrRefinementContainerImpl.this.setAnyArray(i, o);
                return old;
            }
            
            public void add(int i, org.purl.dc.elements.x11.SimpleLiteral o)
                { ElementOrRefinementContainerImpl.this.insertNewAny(i).set(o); }
            
            public org.purl.dc.elements.x11.SimpleLiteral remove(int i)
            {
                org.purl.dc.elements.x11.SimpleLiteral old = ElementOrRefinementContainerImpl.this.getAnyArray(i);
                ElementOrRefinementContainerImpl.this.removeAny(i);
                return old;
            }
            
            public int size()
                { return ElementOrRefinementContainerImpl.this.sizeOfAnyArray(); }
