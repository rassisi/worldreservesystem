 ...
 */
public class LCSHImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements org.purl.dc.terms.LCSH
{
    
    public LCSHImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType, true);
    }
    
    protected LCSHImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
    {
        super(sType, b);
    }
