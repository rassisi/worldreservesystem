 ...
 */
public class BoxImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements org.purl.dc.terms.Box
{
    
    public BoxImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType, true);
    }
    
    protected BoxImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
    {
        super(sType, b);
    }
