 ...
 */
public class SimpleLiteralImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.purl.dc.elements.x11.SimpleLiteral
{
    
    public SimpleLiteralImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
