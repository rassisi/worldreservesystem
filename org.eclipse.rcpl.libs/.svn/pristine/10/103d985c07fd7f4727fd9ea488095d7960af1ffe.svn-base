 ...
 */
public class TGNImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements org.purl.dc.terms.TGN
{
    
    public TGNImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType, true);
    }
    
    protected TGNImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
    {
        super(sType, b);
    }
