 ...
 */
public class UDCImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements org.purl.dc.terms.UDC
{
    
    public UDCImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType, true);
    }
    
    protected UDCImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
    {
        super(sType, b);
    }
