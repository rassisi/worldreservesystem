...
public class JOSlideLayoutDocument extends JOAbstractDocument {

	private JOPresentationDocument presentationDocument;

	public JOSlideLayoutDocument(JOPresentationDocument presentationDocument) {
		super(false, false);
	...
	public JOPresentationDocument getPresentationDocument() {
