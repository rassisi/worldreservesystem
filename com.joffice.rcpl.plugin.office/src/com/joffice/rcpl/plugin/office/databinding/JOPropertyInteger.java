...
public abstract class JOPropertyInteger<Integer> extends JOProperty<Integer>
		implements IObverserObvervable {

	public JOPropertyInteger(JOObject layoutObject, XmlObject xmlParent, XmlObject xmlObject, String key) {
		super(layoutObject, xmlParent, xmlObject, key);
	}

	public JOPropertyInteger(JOObject layoutObject, XmlObject xmlParent, XmlObject xmlObject, String key,boolean immutable) {
