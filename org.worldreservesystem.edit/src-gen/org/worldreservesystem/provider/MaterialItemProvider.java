...
/**
 * This is the item provider adapter for a {@link org.worldreservesystem.Material} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MaterialItemProvider extends IdentityItemProvider {
	/**
	...
	protected void addBelongsToPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Material_belongsTo_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Material_belongsTo_feature",
								"_UI_Material_type"),
						WorldreservesystemPackage.Literals.MATERIAL__BELONGS_TO, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((Material) object).getUUID();
