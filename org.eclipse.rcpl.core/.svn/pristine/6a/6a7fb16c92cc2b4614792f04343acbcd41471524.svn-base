 ...
 *******************************************************************************/
package org.eclipse.rcpl.emf.edit.ui;
 ...
 * </ul>
 */
public class AdapterFactoryTreeCellFactory extends AdapterFactoryCellFactory
		...
		final TreeCell<Object> treeCell = new TreeCell<Object>() {
			...
			public void startEdit() {
				...
				if (o instanceof Resource) {
					boolean isTemplate = ((Resource) o).isTemplate();
					if (isTemplate) {
						return;
					}
				}
