 ...
 * 
 */
public class WrsPerspectiveHomePage extends DefaultPerspectiveHomePage implements IHomePage {

	protected IHomePage homePage;

	public WrsPerspectiveHomePage(IRcplUic uic, HomePage modelHomePage, Pane pane) {
