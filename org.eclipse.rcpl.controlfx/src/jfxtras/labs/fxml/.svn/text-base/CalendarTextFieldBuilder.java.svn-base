...
public class CalendarTextFieldBuilder implements BuilderService<CalendarTextField> {
	...
	public String getLocale() {
		return null;
	} // dummy, just to make it Java Bean compatible

	public void setLocale(String value) {
		iLocale = Locale.forLanguageTag(value);
	}
	...
	public void setDateFormats(String value) {
		...
		iDateFormats = new ArrayList<String>();
	...
	public CalendarTextField build() {
		...
		if (iDateFormat != null)
			lCalendarTextField.setDateFormat(new SimpleDateFormat(iDateFormat, lLocale));
		if (iLocale != null)
			lCalendarTextField.setLocale(iLocale);
		if (iPromptText != null)
			lCalendarTextField.setPromptText(iPromptText);
