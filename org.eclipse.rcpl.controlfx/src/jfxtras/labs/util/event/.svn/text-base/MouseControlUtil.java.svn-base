...
public class MouseControlUtil {
	 ...
	 *
	 * @param n
	 *            the node that shall be made draggable
	 */
	 ...
	 *            selectionn rectangle
	 * @param dragHandler
	 *            additional drag handler (optional, may be <code>null</code>)
	 * @param pressHandler
	 *            additional press handler (optional, may be <code>null</code>)
	 * @param releaseHandler
	 *            additional release handler (optional, may be <code>null</code>
	 *            )
	 * 
	 * @see jfxtras.labs.scene.control.window.Clipboard
	 * @see jfxtras.labs.util.WindowUtil#getDefaultClipboard()
...
class RectangleSelectionControllerImpl {
	...
	public void apply(Parent root, Rectangle rect, EventHandlerGroup<MouseEvent> draggedEvtHandler,
			EventHandlerGroup<MouseEvent> pressedEvtHandler, EventHandlerGroup<MouseEvent> releasedEvtHandler) {
		init(root, rect);
		draggedEvtHandler.addHandler(mouseDraggedEventHandler);
