...
/**
 * A drop-in replacement for JavaFX's VBox using layout constraints. So instead
 * of: VBox lVBox = new VBox(5.0); Button b1 = new Button("short");
 * lVBox.getChildren().add(b1); VBox.setVgrow(b1, Priority.ALWAYS);
 *
 * You can write: VBox lVBox = new VBox(5.0); lVBox.add(new Button("short"), new
 * VBox.C().vgrow(Priority.ALWAYS));
 * 
 * This class is not a reimplementation of VBox, but only applies a different
 * API.
 * 
 * @author Tom Eugelink
 *
