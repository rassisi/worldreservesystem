 ...
 * </p>
 * <ul>
 *   <li>{@link worldreservesystem.impl.IdentityImpl#getUUID <em>UUID</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class IdentityImpl extends MinimalEObjectImpl.Container implements Identity {
	...
	public void setUUID(String newUUID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorldreservesystemPackage.IDENTITY__UUID, oldUUID,
					uuid));
	}
