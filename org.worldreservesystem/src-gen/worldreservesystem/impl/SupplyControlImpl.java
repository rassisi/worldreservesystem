 ...
 * </p>
 * <ul>
 *   <li>{@link worldreservesystem.impl.SupplyControlImpl#getGenesis <em>Genesis</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SupplyControlImpl extends MinimalEObjectImpl.Container implements SupplyControl {
			...
			if (genesis != oldGenesis) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							WorldreservesystemPackage.SUPPLY_CONTROL__GENESIS, oldGenesis, genesis));
			}
		}
		return genesis;
	}
	...
	public void setGenesis(Genesis newGenesis) {
		...
		genesis = newGenesis;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorldreservesystemPackage.SUPPLY_CONTROL__GENESIS,
					oldGenesis, genesis));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case WorldreservesystemPackage.SUPPLY_CONTROL__GENESIS:
			if (resolve)
				return getGenesis();
