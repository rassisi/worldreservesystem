 ...
 * 
 */
public class JOEmu20Property extends JOProperty2 {
	...
	public JOEmu20Property() {
		super(null, null, null, null, null, null);
		data = new JOEmu();
	}

	public JOEmu20Property(String value) {
		super(null, null, null, null, null, null);
		data = new JOEmu(value);
	}

	public JOEmu20Property(JOEmu value) {
		super(null, null, null, null, null, null);
		data = value;
	}

	public JOEmu20Property(int value) {
		super(null, null, null, null, null, null);
		data = new JOEmu(value);
	}
	 ...
	 * @param key
	 */
	public JOEmu20Property(ILayoutObject joObject, XmlObject xmlParent, XmlObject xmlObject, String methodName,
