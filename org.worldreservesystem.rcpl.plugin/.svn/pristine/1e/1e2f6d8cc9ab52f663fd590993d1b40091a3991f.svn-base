 ...
 * 
 */
public class JOEmuProperty extends JOProperty2 implements IEmuProperty2 {
	...
	public JOEmuProperty() {
		super(null, null, null, null, null, null);
		data = new JOEmu();
	}

	public JOEmuProperty(String value) {
		super(null, null, null, null, null, null);
		data = new JOEmu(value);
	}

	public JOEmuProperty(JOEmu value) {
		super(null, null, null, null, null, null);
		data = value;
	}

	public JOEmuProperty(int value) {
		super(null, null, null, null, null, null);
		data = new JOEmu(value);
	}
	 ...
	 * @param key
	 */
	public JOEmuProperty(ILayoutObject joObject, XmlObject xmlParent, XmlObject xmlObject, String methodName,
