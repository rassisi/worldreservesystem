 ...
 * @generated
 */
public class TransferVaultsItemProvider extends LayoutableContainerItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((TransferVaults) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_TransferVaults_type")
				: getString("_UI_TransferVaults_type") + " " + label;
	}
