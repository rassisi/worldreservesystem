 ...
 * @generated
 */
public class WorldEconomyItemProvider extends LayoutableItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((WorldEconomy) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_WorldEconomy_type")
				: getString("_UI_WorldEconomy_type") + " " + label;
	}
