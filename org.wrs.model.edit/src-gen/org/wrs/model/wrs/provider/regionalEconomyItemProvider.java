 ...
 * @generated
 */
public class regionalEconomyItemProvider extends LayoutableItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((regionalEconomy) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_regionalEconomy_type")
				: getString("_UI_regionalEconomy_type") + " " + label;
	}
