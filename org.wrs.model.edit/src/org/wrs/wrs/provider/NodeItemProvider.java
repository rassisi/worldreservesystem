...
/**
 * This is the item provider adapter for a {@link org.wrs.wrs.Node} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NodeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WrsPackage.Literals.NODE__WEIGHT,
				 true,
				 false,
				 false,
	...
	protected void addNetworkenginePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Node_networkengine_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Node_networkengine_feature", "_UI_Node_type"),
				 WrsPackage.Literals.NODE__NETWORKENGINE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WrsPackage.Literals.NODE__WRS);
		}
