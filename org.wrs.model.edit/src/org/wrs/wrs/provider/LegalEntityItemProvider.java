...
/**
 * This is the item provider adapter for a {@link org.wrs.wrs.LegalEntity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LegalEntityItemProvider extends IdentityItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LegalEntity_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LegalEntity_type_feature", "_UI_LegalEntity_type"),
				 WrsPackage.Literals.LEGAL_ENTITY__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((LegalEntity)object).getUUID();
