...
/**
 * This is the item provider adapter for a {@link org.wrs.wrs.Country} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Country_nationaleconomies_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Country_nationaleconomies_feature", "_UI_Country_type"),
				 WrsPackage.Literals.COUNTRY__NATIONALECONOMIES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addRegionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Country_regions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Country_regions_feature", "_UI_Country_type"),
				 WrsPackage.Literals.COUNTRY__REGIONS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WrsPackage.Literals.COUNTRY__FIATCURRENCY,
