...
/**
 * This is the item provider adapter for a {@link worldreservesystem.Transaction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Transaction_from_feature",
								"_UI_Transaction_type"),
						WorldreservesystemPackage.Literals.TRANSACTION__FROM, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Transaction_to_feature",
								"_UI_Transaction_type"),
						WorldreservesystemPackage.Literals.TRANSACTION__TO, true, false, true, null, null, null));
	}
